...
export default function QuoteTemplate({ packageData }) {
  ...
  return (
    <div className="quote-template-wrapper font-sans">
      {/* Page 1 */}
      <div 
        className="w-[210mm] h-[297mm] p-6 overflow-hidden print:break-after-page flex flex-col"
        style={{ 
      ...
      >
        ...
        <div 
          className="text-center mb-4 py-4 px-4 rounded-lg"
          style={{
        ...
        {/* Intro Text */}
        <p className="text-xs mb-4 leading-relaxed" style={{ color: '#E5E7EB' }}>
        ...
        >
          <h4 className="text-lg font-bold mb-2 tracking-wide" style={{ color: '#FFFFFF' }}>
        ...
        <div className="mb-4">
          <div className="flex items-center mb-2">
            <div className="w-1 h-5 mr-2" style={{ backgroundColor: '#10b981' }}></div>
            <h3 className="text-xl font-bold uppercase tracking-wide" style={{ color: '#34d399' }}>
              Engagement Details
            </h3>
          </div>
          ...
          <div 
            className="rounded-lg p-4 space-y-2 shadow-md"
            style={{
              backgroundColor: '#0E1116',
              border: '2px solid rgba(16,185,129,0.3)'
            }}
          >
            <div className="flex justify-between items-center py-1.5" style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
              <span className="text-xs" style={{ color: '#9CA3AF' }}>Selected Option:</span>
              <span className="text-base font-semibold" style={{ color: '#FFFFFF' }}>{packageData.selected_option}</span>
            </div>
            <div className="flex justify-between items-center py-1.5" style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
              <span className="text-xs" style={{ color: '#9CA3AF' }}>Audit Fee:</span>
              <span className="text-base font-bold" style={{ color: '#34d399' }}>$5,000</span>
            </div>
            {packageData.calculated_retainer > 0 && (
              <>
                <div className="flex justify-between items-center py-1.5" style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                  <span className="text-xs" style={{ color: '#9CA3AF' }}>Monthly Retainer:</span>
                  <span className="text-base font-bold" style={{ color: '#34d399' }}>
                    ${packageData.calculated_retainer.toLocaleString()}/month
                  </span>
                </div>
                <div className="flex justify-between items-center py-1.5" style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                  <span className="text-xs" style={{ color: '#9CA3AF' }}>Probation Period:</span>
            ...
            {packageData.decision_deadline && (
              <div className="flex justify-between items-center py-1.5">
                <span className="text-xs" style={{ color: '#9CA3AF' }}>Decision Deadline:</span>
                <span className="text-base font-semibold" style={{ color: '#FFFFFF' }}>
        ...
        {(packageData.company_scale || packageData.annual_revenue || packageData.gross_profit_margin || packageData.growth_target) && (
          <div className="mb-4">
            ...
            <div 
              className="rounded-lg p-4 grid grid-cols-2 gap-3 shadow-md"
              style={{
                backgroundColor: '#0E1116',
                border: '2px solid rgba(16,185,129,0.3)'
              }}
            >
              {packageData.company_scale && (
                <div className="py-1">
                  <p className="text-[10px] mb-1 uppercase tracking-wider" style={{ color: '#6B7280' }}>
                    Company Scale
                  </p>
      ...
      >
          ...
          <div className="mb-4">
            ...
            >
              <div className="flex items-start gap-2">
                <span className="text-lg font-bold flex-shrink-0" style={{ color: '#34d399' }}>&gt;</span>
        ...
        {packageData.notes && (
          <div className="mb-4">
            ...
            >
              <p className="text-xs leading-relaxed whitespace-pre-wrap" style={{ color: '#E5E7EB' }}>
                {packageData.notes}
              </p>
            </div>
          </div>
